...
M_Audio::M_Audio(bool start_enabled) : Module("Audio", start_enabled) {}
...
void M_Audio::LoadSoundBank(const char* path)
{
...
void M_Audio::Tests(AkGameObjectID id)
{
